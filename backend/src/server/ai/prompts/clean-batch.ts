...
* Mobile: valid Indian mobile = 10 to 14 total digits where the last 10 digits start with 6/7/8/9. Output exactly those last 10 digits for mobile/mobile_without_country_code fields. Use first valid mobile in input order. Extra valid mobiles go to notes if notes field exists. Reject landlines and numbers shorter than 10 or longer than 14 digits. Never repair landlines.
