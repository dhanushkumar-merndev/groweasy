...
export default async function SavedTablePage({
  ...
  return (
    <AppShell title={job.import_name} description="Saved campaign rows with review-style inline editing." actions={<ExportMenu importId={importId} />}>
      <div className="grid gap-4">
        <SheetTabs sheets={importData.sheets} basePath={`/campaigns/${importId}`} activeSheet={sheet} />
