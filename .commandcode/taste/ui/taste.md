# ui
- All buttons must use useTransition hook for loading states, keeping button width stable during loading transitions with the loading animation centered inside the button. Confidence: 0.70
